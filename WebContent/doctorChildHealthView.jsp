		...
		<div class="intro-content">
            ...
            <td><%=res.getString("address") %></td> 
             ...
             <td class="text-center">
              ...
              <a href='DoctorviewChildHealthDetails.jsp?chId=<%=res.getString("chId") %>' class="btn btn-primary"  onClick="return confirm('Are you absolutely sure you want to view?')"><i class="fa fa-search"></i>View</a>
             </td>
             </tr>
             <%} %>
