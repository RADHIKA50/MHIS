		...
		<div class="intro-content">
			...
			<div class="container">
				<div class="row">
					...
					<h2 class="h-ultra">Forgot Password?</h2>
					</div>
						...
						<div class="container well well-trans">
							<div class="container" style="color:#4ACDD1">
								<div class="row">
								<div class="col-md-12 ">
								<form class="form-horizontal" action="forgotPassword.jsp" method="POST" name="myForm" onsubmit="return validateForm()" >
								
								<fieldset>
								
								<div class="col-md-offset-4"><p style="color:green;font-type:bold;">* Please fill the following to recover your password</p></div>
								...
								<div class="form-group">
								  ...
								  <div class="col-md-4"><input  type="submit" class="btn btn-success col-md-12" value="Next" src="forgot2.jsp">
