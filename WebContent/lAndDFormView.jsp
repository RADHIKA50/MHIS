		...
		<div class="intro-content">
			...
			<div class="container">
				<div class="row">
					...
					<h2 class="h-ultra">Labor And Delivery Information View </h2>
					</div>
             ...
             <a href="lAndDForm.jsp" class="btn btn-success"><i class="fa fa-plus">Add</i></a>
             </div>
             <br>
             ...
             String data;
             if(query!=null){
            	 data ="select * from landd where mother like'%"+query+"%'";
             }else{
            	 data ="select * from landd order by LdId desc";
             }
             ...
             <td><%=res.getString("cardNoDate") %></td>
              
     
             <td class="text-center">
             <a href='editlAndDDetails.jsp?LdId=<%=res.getString("LdId") %>' class="btn btn-success"  onClick="return confirm('Are you absolutely sure you want to update?')""><i class="fa fa-edit"></i>Edit</a>
             <a href='viewLandDDetails.jsp?LdId=<%=res.getString("LdId") %>' class="btn btn-primary"  onClick="return confirm('Are you absolutely sure you want to view?')"><i class="fa fa-search"></i>View</a>
             </td>
             </tr>
             <%} %>
