...
<div id="wrapper">
 ...
 <li><a href="#" data-original-title="Edit this user" class="btn btn-info btn-sm" type="button" >Edit Your Profile</a></li> 
         ...
         <% 
                ...
                ResultSet rs = statement.executeQuery("select fullName,username,email,gender,address,dob,position,phoneNumber from users where position='Maternity Incharge'") ; 
        %>
