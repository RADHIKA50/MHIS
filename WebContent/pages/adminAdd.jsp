					...
					<h2 class="h-ultra">Add User</h2>
						...
						<div class="container well well-trans">
							<div class="container" style="color:#4ACDD1">
								<div class="row">
								<div class="col-md-12 ">
								<form class="form-horizontal" action="adminRegister.jsp" method="POST" >
								<fieldset>
							...
							<!-- Text input-->
								...
								<a href="adminView.jsp" class="btn btn-default" style="background-color:#4acdd1"><span class="glyphicon glyphicon-arrow-left"></span> Back</a>
