		...
		<div class="intro-content">
			...
			<div class="container">
				<div class="row">
					...
					<h2 class="h-ultra">Child Health View </h2>
					</div>
             ...
             <div class="row">
              <div class="col-md-4">
            	...
            	<div class="col-md-6"><input type="text" class="form-control" name="q" placeholder="Enter Baby ID"></div>
            	</form>
             </div>
             <div class="col-md-4"></div>
             
             <div class="col-md-4 text-right">
             <a href="childHealthForm.jsp" class="btn btn-success"><i class="fa fa-plus">Add</i></a>
             </div>
             <br>
             ...
             String data;
             if(query!=null){
            	 data ="select * from childhealth where babyName like'%"+query+"%'";
             }else{
            ...
            <td><%=res.getString("address") %></td> 
             ...
             <a href='editchildHealthDetails.jsp?chId=<%=res.getString("chId") %>' class="btn btn-success"  onClick="return confirm('Are you absolutely sure you want to update?')""><i class="fa fa-edit"></i>Edit</a>
             <a href='viewChildHealthDetails.jsp?chId=<%=res.getString("chId") %>' class="btn btn-primary"  onClick="return confirm('Are you absolutely sure you want to view?')"><i class="fa fa-search"></i>View</a>
             </td>
             </tr>
             <%} %>
