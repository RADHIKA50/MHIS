		...
		<div class="intro-content">
			...
			<div class="container">
				<div class="row">
					...
					<h2 class="h-ultra">Track Delivery Date</h2>
					</div>
             ...
             <div class="row">
              <div class="col-md-12">
            	...
            	<div class="col-md-4"><input type="text" placeholder="Registration Date" class="form-control" name="q" placeholder="Enter Registration Date">
             ...
             String data;
             if(query!=null){
            	 data ="select * from landd where deliveryDate like'%"+query+"%'";
             }else{
             ...
             <td><%=res.getString("pregnacyProblem") %></td>
             <td><%=res.getString("DeliveryMethod") %></td>
             
             <td><%=res.getString("laborPain") %></td>
             <td><%=res.getString("deliveryDate") %></td>
             
              
              
             <td class="text-center">
             <a href='viewLandDDetails.jsp?LdId=<%=res.getString("LdId") %>' class="btn btn-primary"  ><i class="fa fa-search"></i>View</a>
             </td>
             </tr>
             <%} %>
