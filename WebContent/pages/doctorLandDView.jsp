    ...
    <section class="intro">
		<div class="intro-content">
			...
			<div class="container">
             ...
             <a href='DoctorviewLandDDetails.jsp?LdId=<%=res.getString("LdId") %>' class="btn btn-primary"  onClick="return confirm('Are you absolutely sure you want to view?')"><i class="fa fa-search"></i>View</a>
             </td>
             </tr>
             <%} %>
