                    ...
                    <fieldset>
                     ...
                     <fieldset>
                        ...
                        <div class="form-bottom">
                         ...
                         <div class="form-group">
                                <input type="date" class="form-control" name="dateOfRegistration" placeholder="Registration Date" value="<%=resultSet.getString("dateOfRegistration") %>" id="pref_date">
                            </div>
                        ...
                        <div class="form-bottom">
                            ...
                            <div class="row">
                            <div class="form-group col-md-4 col-sm-4">
                                <input type="date" name="hivdatetest" class="form-control" Placeholder="HIV Date Test" value="<%=resultSet.getString("hivdatetest") %>" id="pref_date">
                            </div>
                            <div class="form-group col-md-4 col-sm-4">
