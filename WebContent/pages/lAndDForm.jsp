    ...
    <section class="intro">
        ...
        <div class="col-md-offset-2" style="margin-top:-53px;">
            <div class="col-md-10 form-box" >
                <form role="form" class="registration-form" action="landProcess.jsp" method="post" name="myForm" onsubmit="return validateForm()">
                    <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="input-group"><div class="input-group-addon"><i class="fa fa-credit-card"></i> </div>
                                    <select class="form-control" name="reportName">
                                            ...
                                            <option>Child Death</option>
                                            <option>Mother Death</option>
                                            <option>Surgery Delivery</option>
                                            <option>Early Infant Delivery</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group col-md-8 col-sm-8">
                                <div class="input-group"><div class="input-group-addon"><i class="fa fa-user"></i> </div>
                                    <input type="text" class="form-control" name="mother" placeholder="Mother" id="lname">
                                    </div>
                                </div>
                            </div>
                             <div class="row">
                             ...
                             <div class="row">
                                <div class="form-group col-md-6 col-sm-6">
                                 <div class="input-group">
                                    ...
                                    <input type="text" class="form-control textbox-n" name="cardNoDate" onfocus="(this.type='date')" onblur="(this.type='text')" placeholder="card Number Date" id="fname">
                                    </div>
                                </div>
                                <div class="form-group col-md-6 col-sm-6">
                                <div class="input-group"><div class="input-group-addon"><i class="fa fa-user"></i> </div>
                                <select class="form-control" name="babyGender">
                                    <option>Baby Gender</option>
                                    <option>Male</option>
                    ...
                    <fieldset>
                       ...
                       <div class="form-group col-md-6 col-sm-6">
                            <div class="input-group"><div class="input-group-addon"><i class="fa fa-question-circle"></i> </div>
                                        <select class="form-control" name="laborPain">
                                            <option>Had Labor Pain?</option>
                                            <option>Yes</option>
                                            <option>No</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 col-sm-6">
                            <div class="input-group"><div class="input-group-addon"><i class="fa fa-question-circle"></i> </div>
                                        <select class="form-control" name="pregnacyProblem">
                                            <option>Had Pregnancy Problem?</option>
                                            <option>Yes</option>
                                            <option>No</option>
                           ...
                           <div class="form-group col-md-4 col-sm-4">
                           <div class="input-group"><div class="input-group-addon"><i class="fa fa-question-circle"></i> </div>
                                <select class="form-control" name="pregnacyResults">
                               
                                    <option>Pregnancy Result</option>
                     ...
                     <fieldset>
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                         <div class="input-group"><div class="input-group-addon"><i class="fa fa-card"></i> </div>
                                <input type="text" class="form-control" name="apgarScoreId" placeholder="ApGarscore ID" id="pref_date">
                                </div>
                            </div>
                            
                           <div class="form-group col-md-4 col-sm-4">
                           <div class="input-group"><div class="input-group-addon"><i class="fa fa-question-circle"></i> </div>
                                        <select class="form-control" name="hbb">
                                            <option>HBB</option>
                                            <option>Yes</option>
                                            <option>No</option>
                                        </select>
                                    ...
                                    <div class="input-group"><div class="input-group-addon"><i class="fa fa-weight"></i> </div>
                                        <select class="form-control" name="babyWeight">
                         		...
                         		<div class="row">
                                     <div class="form-group col-md-6 col-sm-6">
                                     <div class="input-group"><div class="input-group-addon"><i class="fa fa-question-circle"></i> </div>
                                <select class="form-control"  name="fsb">
                                    <option>FSB</option>
                                    <option>Yes</option>
                                    <option>No</option>
                                </select>
                            ...
                            <div class="form-group col-md-6 col-sm-6">
                                <select class="form-control" name="msb">
                                    <option>MSB</option>
                                      <option>Yes</option>
                                      <option>No</option>
                                </select>
