    ...
    <section class="intro">
		<div class="intro-content">
			...
			<div class="container">
             ...
             <a href="pncForm.jsp" class="btn btn-success"><i class="fa fa-plus">Add</i></a>
             </div>
             <br>
             ...
             <a href='editPncDetails.jsp?pncId=<%=res.getString("pncId") %>'  class="btn btn-success"  onClick="return confirm('Are you absolutely sure you want to update?')""><i class="fa fa-edit"></i>Edit</a>
             <a href='pncViewDetails.jsp?pncId=<%=res.getString("pncId") %>'   class="btn btn-primary"  onClick="return confirm('Are you absolutely sure you want to view?')"><i class="fa fa-search"></i>View</a>
             </td>
             </tr>
             <%} %>
