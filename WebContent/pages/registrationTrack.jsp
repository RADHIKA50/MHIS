		...
		<div class="intro-content">
			...
			<div class="container">
				<div class="row">
					...
					<h2 class="h-ultra">Track Registration Date</h2>
					</div>
             ...
             <th>address</th>
             <th>dob</th>
             <th>optphoneNumber</th>
			 <th>status</th>
			 <th>pregnancyLossNum</th>
             <th>lastchildage</th>
             <th>surgicaldelivery</th>
             <th>placedelivered</th>
             <th>height</th>
             <th>weight</th>
             <th>pregnantyear</th>
             <th>weeklyPregnancyage</th>
             <th>TT1vaccinationdate</th>
             <th>TT2VaccinationDate</th>
             <th>bp</th>
             <th>tb</th>
             <th>syphilistest</th>
             <th>malariatest</th>
             <th>wormsmedicine</th>
             <th>hivinfectiontest</th>
             <th>urinesugaramount</th>
             <th>fataken</th>
             <th>ifataken</th>
             <th>prePregnancyDescrition</th>
             <th>pregnancyage</th>
             <th>bloodgroup</th>
             <th>hivdatetest</th>
             <th>hivresult</th>-->
             ...
             String data;
             if(query!=null){
            	 data ="select * from anc where dateOfRegistration like'%"+query+"%'";
             }else{
