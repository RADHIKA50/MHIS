    ...
    <section class="intro">
        ...
        <div class="col-md-offset-2" style="margin-top:-53px;">
            <div class="col-md-10 form-box" >
                <form role="form" class="registration-form" action="pncProcess.jsp" method="post" name="myForm" onsubmit="return validateForm()" >
                    <fieldset>
                        ...
                        <div class="form-bottom">
                            <div class="row">
                                ...
                                <div class="input-group"><div class="input-group-addon"><i class="fa fa-user"></i> </div>
                                    <input type="text" class="form-control" name="motherName" placeholder="Mother Name" id="lname">
                                    </div>
                                </div>
                            </div>
                             <div class="row">
                                ...
                                <div class="input-group"><div class="input-group-addon"><i class="fa fa-credit-card"></i> </div>
                                    <input type="text" class="form-control" name="cardNumber" placeholder="Card Number" id="fname">
                                    </div>
                                </div>
                             ...
                             <div class="row">
                                ...
                                <div class="form-group col-md-6 col-sm-6">
                                 <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="timesGivenBirth"  placeholder="times Given Birth" id="fname">
                                    </div>
                                </div>
                             ...
                             <div class="row">
                                <div class="form-group col-md-6 col-sm-6">
                                 <div class="input-group">
                                    ...
                                    <input type="text" class="form-control textbox-n" name="deliveryDate" onfocus="(this.type='date')" onblur="(this.type='text')" placeholder="Delivery Date" id="fname">
                                    </div>
                                </div>
                               ...
                               <div class="input-group"><div class="input-group-addon"><i class="fa fa-hospital-o"></i> </div>
                                <select class="form-control" name="deliveryPlace">
                                    ...
                                    <option>Place you Delivered</option>
                     ...
                     <fieldset>
                        ...
                        <div class="form-bottom">
                           ...
                           <div class="input-group"><div class="input-group-addon"><i class="fa fa-ruler"></i> </div>
                                        <select class="form-control" name="hivTest">
                                    ...
                                    <div class="form-group col-md-4 col-sm-4">
                                    <div class="input-group"><div class="input-group-addon"><i class="fa fa-ruler"></i> </div>
                                        <select class="form-control" name="fistulaTest">
                                            <option>fistula Test</option>
                                            <option>Yes</option>
                                            <option>No</option>
                                        </select>
                                        </div>
                            ...
                            <div class="input-group"><div class="input-group-addon"><i class="fa fa-vaccine"></i> </div>
                                <select class="form-control" name="babyVaccination">
                                    <option>Baby Vaccination</option>
                                      <option>Yes</option>
                                      <option>No</option>
                                </select>
                                </div>
                                ...
                                <input type="text" class="form-control" name="babyTemperature"  placeholder="Baby Temperature" id="pref_date">
                                </div>
                            </div>
                            </div>
                            ...
                            <div class="row">
                             <div class="form-group col-md-6 col-sm-6">
                                ...
                                <input type="text" class="form-control" name="haemoglobin"  placeholder="Haemoglobin" id="pref_date">
                                </div>
                            </div>
                              <div class="form-group col-md-6 col-sm-6">
                                <div class="input-group"><div class="input-group-addon"><i class="fa fa-animal"></i> </div>
                                <select class="form-control" name="KMC">
                                    <option>KMC</option>
                                      <option>Yes</option>
                                      <option>No</option>
                                </select>
