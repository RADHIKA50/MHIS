				...
				<div class="row">
					...
					<h2 class="h-ultra">SMS</h2>
						...
						<!-- <form action="SendSms.jsp" method="post">
						 To<input type="text" name="senderNumber"><br>
						 ...
						 -->
							...
							<form action="SendSms.jsp" method="post">
							  <div class="form-group">
							    <label for="receiverNumber">To:</label>
							   <!--  <input type="text" class="form-control" name="senderNumber"> -->
							  ...
							  <div class="form-group">
							    ...
							    <textarea class="form-control" name="message" rows="8" cols="5">Dear Mother!  You are requered to attend clinic on 20-04-2019.Please come on time.</textarea>
							  </div>
